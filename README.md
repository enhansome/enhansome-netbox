...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,551 | 🐛 221 | 🌐 Python | 📅 2026-09-18 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 14 | 🌐 Python | 📅 2026-09-18 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,769 | 🐛 14 | 🌐 Python | 📅 2026-09-17 - Docker Image of NetBox.
...
* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,602 | 🐛 36 | 🌐 Python | 📅 2026-09-18 - A collection of community-sourced DeviceType definitions.
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 414 | 🐛 28 | 🌐 Python | 📅 2026-09-15 - Sync objects from VMware or redfish sources to NetBox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,551 | 🐛 221 | 🌐 Python | 📅 2026-09-18 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
