...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,510 | 🐛 217 | 🌐 Python | 📅 2026-09-11 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 13 | 🌐 Python | 📅 2026-09-11 - Ansible collection with service roles.
...
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 355 | 🐛 9 | 🌐 Mustache | 📅 2026-09-11 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,598 | 🐛 29 | 🌐 Python | 📅 2026-09-11 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 394 | 🐛 61 | 🌐 Python | 📅 2026-09-10 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,510 | 🐛 217 | 🌐 Python | 📅 2026-09-11 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
