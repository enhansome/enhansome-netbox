...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,504 | 🐛 211 | 🌐 Python | 📅 2026-09-10 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* 📖 [NetBox Plugin Tutorial](https://github.com/netbox-community/netbox-plugin-tutorial) ⭐ 138 | 🐛 4 | 📅 2026-03-18 - NetBox Plugin Development Tutorial.
...
* [netbox-community/ansible\_modules](https://github.com/netbox-community/ansible_modules) ⭐ 398 | 🐛 244 | 🌐 Python | 📅 2026-09-01 - NetBox modules for Ansible using Ansible Collections.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 14 | 🌐 Python | 📅 2026-09-10 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,759 | 🐛 13 | 🌐 Python | 📅 2026-09-10 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 355 | 🐛 8 | 🌐 Mustache | 📅 2026-09-08 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,596 | 🐛 35 | 🌐 Python | 📅 2026-09-10 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 394 | 🐛 60 | 🌐 Python | 📅 2026-09-08 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
* [minitriga/Netbox-Device-Type-Library-Import](https://github.com/minitriga/Netbox-Device-Type-Library-Import) ⭐ 387 | 🐛 56 | 🌐 Python | 📅 2025-03-11 - The library is intended to be your friend and help you import all the device-types defined within the the NetBox Device Type Library Repository.
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 412 | 🐛 30 | 🌐 Python | 📅 2026-09-10 - Sync objects from VMware or redfish sources to NetBox.
* [TheNetworkGuy/netbox-zabbix-sync](https://github.com/TheNetworkGuy/netbox-zabbix-sync) ⭐ 230 | 🐛 37 | 🌐 Python | 📅 2026-07-20 - Python script to syncronise Netbox devices to Zabbix.
...
* [netbox-community/pynetbox](https://github.com/netbox-community/pynetbox) ⭐ 683 | 🐛 7 | 🌐 Python | 📅 2026-09-08 - Python API client library.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 293 | 🐛 189 | 🌐 Go | 📅 2026-09-09 - Terraform provider to interact with Netbox.
* [smutel/terraform-provider-netbox](https://github.com/smutel/terraform-provider-netbox) ⭐ 67 | 🐛 4 | 🌐 Go | 📅 2026-09-02 - Terraform provider for Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,504 | 🐛 211 | 🌐 Python | 📅 2026-09-10 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
