...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,530 | 🐛 215 | 🌐 Python | 📅 2026-09-14 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 13 | 🌐 Python | 📅 2026-09-14 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,764 | 🐛 13 | 🌐 Python | 📅 2026-09-14 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 357 | 🐛 10 | 🌐 Mustache | 📅 2026-09-14 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,598 | 🐛 36 | 🌐 Python | 📅 2026-09-14 - A collection of community-sourced DeviceType definitions.
...
* [netbox-community/pynetbox](https://github.com/netbox-community/pynetbox) ⭐ 685 | 🐛 7 | 🌐 Python | 📅 2026-09-08 - Python API client library.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,530 | 🐛 215 | 🌐 Python | 📅 2026-09-14 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
