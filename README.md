...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,441 | 🐛 198 | 🌐 Python | 📅 2026-09-01 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,749 | 🐛 14 | 🌐 Python | 📅 2026-08-31 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 354 | 🐛 7 | 🌐 Mustache | 📅 2026-09-01 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,595 | 🐛 57 | 🌐 Python | 📅 2026-09-01 - A collection of community-sourced DeviceType definitions.
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 409 | 🐛 58 | 🌐 Python | 📅 2026-09-01 - Sync objects from VMware or redfish sources to NetBox.
...
* [netbox-community/pynetbox](https://github.com/netbox-community/pynetbox) ⭐ 682 | 🐛 8 | 🌐 Python | 📅 2026-08-31 - Python API client library.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 291 | 🐛 187 | 🌐 Go | 📅 2026-09-01 - Terraform provider to interact with Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,441 | 🐛 198 | 🌐 Python | 📅 2026-09-01 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
