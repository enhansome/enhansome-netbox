...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,521 | 🐛 217 | 🌐 Python | 📅 2026-09-11 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 13 | 🌐 Python | 📅 2026-09-13 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,761 | 🐛 13 | 🌐 Python | 📅 2026-09-10 - Docker Image of NetBox.
...
* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,598 | 🐛 37 | 🌐 Python | 📅 2026-09-13 - A collection of community-sourced DeviceType definitions.
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 411 | 🐛 30 | 🌐 Python | 📅 2026-09-10 - Sync objects from VMware or redfish sources to NetBox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,521 | 🐛 217 | 🌐 Python | 📅 2026-09-11 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
