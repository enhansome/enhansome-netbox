...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,533 | 🐛 209 | 🌐 Python | 📅 2026-09-15 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 14 | 🌐 Python | 📅 2026-09-15 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,766 | 🐛 14 | 🌐 Python | 📅 2026-09-15 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 357 | 🐛 10 | 🌐 Mustache | 📅 2026-09-15 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,598 | 🐛 38 | 🌐 Python | 📅 2026-09-14 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 394 | 🐛 62 | 🌐 Python | 📅 2026-09-10 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
...
* [netbox-community/pynetbox](https://github.com/netbox-community/pynetbox) ⭐ 684 | 🐛 7 | 🌐 Python | 📅 2026-09-08 - Python API client library.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,533 | 🐛 209 | 🌐 Python | 📅 2026-09-15 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
