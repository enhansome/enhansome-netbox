...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,322 | 🐛 213 | 🌐 Python | 📅 2026-08-17 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,729 | 🐛 14 | 🌐 Python | 📅 2026-08-13 - Docker Image of NetBox.
...
* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,585 | 🐛 32 | 🌐 Python | 📅 2026-08-14 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 393 | 🐛 59 | 🌐 Python | 📅 2026-08-13 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
...
* [netbox-community/pynetbox](https://github.com/netbox-community/pynetbox) ⭐ 681 | 🐛 4 | 🌐 Python | 📅 2026-07-21 - Python API client library.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 291 | 🐛 145 | 🌐 Go | 📅 2026-08-17 - Terraform provider to interact with Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,322 | 🐛 213 | 🌐 Python | 📅 2026-08-17 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
