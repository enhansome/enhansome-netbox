...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,446 | 🐛 200 | 🌐 Python | 📅 2026-09-02 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 36 | 🐛 13 | 🌐 Python | 📅 2026-09-01 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,751 | 🐛 14 | 🌐 Python | 📅 2026-08-31 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 354 | 🐛 6 | 🌐 Mustache | 📅 2026-09-02 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,594 | 🐛 59 | 🌐 Python | 📅 2026-09-02 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 393 | 🐛 58 | 🌐 Python | 📅 2026-09-01 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 410 | 🐛 59 | 🌐 Python | 📅 2026-09-02 - Sync objects from VMware or redfish sources to NetBox.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 291 | 🐛 189 | 🌐 Go | 📅 2026-09-02 - Terraform provider to interact with Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,446 | 🐛 200 | 🌐 Python | 📅 2026-09-02 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
