...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,459 | 🐛 201 | 🌐 Python | 📅 2026-09-03 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [netbox-community/ansible\_modules](https://github.com/netbox-community/ansible_modules) ⭐ 397 | 🐛 244 | 🌐 Python | 📅 2026-09-01 - NetBox modules for Ansible using Ansible Collections.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 36 | 🐛 13 | 🌐 Python | 📅 2026-09-03 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,754 | 🐛 14 | 🌐 Python | 📅 2026-09-02 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 355 | 🐛 7 | 🌐 Mustache | 📅 2026-09-03 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,595 | 🐛 40 | 🌐 Python | 📅 2026-09-03 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 394 | 🐛 59 | 🌐 Python | 📅 2026-09-03 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
* [minitriga/Netbox-Device-Type-Library-Import](https://github.com/minitriga/Netbox-Device-Type-Library-Import) ⭐ 386 | 🐛 56 | 🌐 Python | 📅 2025-03-11 - The library is intended to be your friend and help you import all the device-types defined within the the NetBox Device Type Library Repository.
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 410 | 🐛 64 | 🌐 Python | 📅 2026-09-02 - Sync objects from VMware or redfish sources to NetBox.
...
* [netbox-community/pynetbox](https://github.com/netbox-community/pynetbox) ⭐ 682 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - Python API client library.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 291 | 🐛 190 | 🌐 Go | 📅 2026-09-02 - Terraform provider to interact with Netbox.
* [smutel/terraform-provider-netbox](https://github.com/smutel/terraform-provider-netbox) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - Terraform provider for Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,459 | 🐛 201 | 🌐 Python | 📅 2026-09-03 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
