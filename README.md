...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,433 | 🐛 191 | 🌐 Python | 📅 2026-08-31 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 35 | 🐛 11 | 🌐 Python | 📅 2026-08-28 - Ansible collection with service roles.
...
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 354 | 🐛 6 | 🌐 Mustache | 📅 2026-08-31 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,595 | 🐛 56 | 🌐 Python | 📅 2026-08-29 - A collection of community-sourced DeviceType definitions.
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 408 | 🐛 56 | 🌐 Python | 📅 2026-05-16 - Sync objects from VMware or redfish sources to NetBox.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 292 | 🐛 188 | 🌐 Go | 📅 2026-08-31 - Terraform provider to interact with Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,433 | 🐛 191 | 🌐 Python | 📅 2026-08-31 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
