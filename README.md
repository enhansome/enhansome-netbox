...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,563 | 🐛 220 | 🌐 Python | 📅 2026-09-18 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 14 | 🌐 Python | 📅 2026-09-20 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,769 | 🐛 16 | 🌐 Python | 📅 2026-09-18 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 357 | 🐛 7 | 🌐 Mustache | 📅 2026-09-20 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,601 | 🐛 38 | 🌐 Python | 📅 2026-09-18 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 394 | 🐛 61 | 🌐 Python | 📅 2026-09-19 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 294 | 🐛 190 | 🌐 Go | 📅 2026-09-09 - Terraform provider to interact with Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,563 | 🐛 220 | 🌐 Python | 📅 2026-09-18 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
