...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,492 | 🐛 214 | 🌐 Python | 📅 2026-09-07 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 36 | 🐛 14 | 🌐 Python | 📅 2026-09-06 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,756 | 🐛 15 | 🌐 Python | 📅 2026-09-02 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 355 | 🐛 8 | 🌐 Mustache | 📅 2026-09-07 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,595 | 🐛 32 | 🌐 Python | 📅 2026-09-07 - A collection of community-sourced DeviceType definitions.
...
* [netbox-community/pynetbox](https://github.com/netbox-community/pynetbox) ⭐ 682 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Python API client library.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,492 | 🐛 214 | 🌐 Python | 📅 2026-09-07 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
