...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,472 | 🐛 211 | 🌐 Python | 📅 2026-09-04 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 36 | 🐛 13 | 🌐 Python | 📅 2026-09-04 - Ansible collection with service roles.
...
* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,595 | 🐛 48 | 🌐 Python | 📅 2026-09-03 - A collection of community-sourced DeviceType definitions.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 291 | 🐛 186 | 🌐 Go | 📅 2026-09-04 - Terraform provider to interact with Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,472 | 🐛 211 | 🌐 Python | 📅 2026-09-04 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
