...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,537 | 🐛 208 | 🌐 Python | 📅 2026-09-16 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 14 | 🌐 Python | 📅 2026-09-16 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,766 | 🐛 13 | 🌐 Python | 📅 2026-09-15 - Docker Image of NetBox.
* [netbox-community/netbox-chart](https://github.com/netbox-community/netbox-chart) ⭐ 357 | 🐛 7 | 🌐 Mustache | 📅 2026-09-16 - Helm Chart for NetBox.

## Utilities

* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,599 | 🐛 38 | 🌐 Python | 📅 2026-09-16 - A collection of community-sourced DeviceType definitions.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,537 | 🐛 208 | 🌐 Python | 📅 2026-09-16 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
