...
[NetBox](https://github.com/netbox-community/netbox) ⭐ 21,491 | 🐛 212 | 🌐 Python | 📅 2026-09-08 is an infrastructure resource modeling (IRM) tool providing the ideal <strong>"source of truth"</strong> to power network automation.
...
* [osism/ansible-collection-services](https://github.com/osism/ansible-collection-services) ⭐ 37 | 🐛 15 | 🌐 Python | 📅 2026-09-08 - Ansible collection with service roles.

## Deployment

* [netbox-community/netbox-docker](https://github.com/netbox-community/netbox-docker) ⭐ 2,756 | 🐛 15 | 🌐 Python | 📅 2026-09-08 - Docker Image of NetBox.
...
* [netbox-community/devicetype-library](https://github.com/netbox-community/devicetype-library) ⭐ 1,595 | 🐛 29 | 🌐 Python | 📅 2026-09-08 - A collection of community-sourced DeviceType definitions.
* [Solvik/netbox-agent](https://github.com/Solvik/netbox-agent) ⭐ 394 | 🐛 59 | 🌐 Python | 📅 2026-09-04 - Project aims to create hardware automatically into Netbox based on standard tools (dmidecode, lldpd, parsing /sys/, etc).
...
* [bb-Ricardo/netbox-sync](https://github.com/bb-Ricardo/netbox-sync) ⭐ 411 | 🐛 58 | 🌐 Python | 📅 2026-09-07 - Sync objects from VMware or redfish sources to NetBox.
...
* [e-breuninger/terraform-provider-netbox](https://github.com/e-breuninger/terraform-provider-netbox) ⭐ 293 | 🐛 188 | 🌐 Go | 📅 2026-09-07 - Terraform provider to interact with Netbox.
...
* [GitHub Discussions](https://github.com/netbox-community/netbox/discussions) ⭐ 21,491 | 🐛 212 | 🌐 Python | 📅 2026-09-08 - Discussion forum hosted by GitHub; ideal for Q\&A and other structured discussions.
